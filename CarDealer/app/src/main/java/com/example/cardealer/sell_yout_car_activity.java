...
public class sell_yout_car_activity extends AppCompatActivity {
    ...
    private String brand , name , year, KM,describtion,price , fuelC ,TransmissionC,phone, upload_in_detabase , downloadImag , finalDownlaod ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sell_yout_car_avtivity);
        ...
        continue_but.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (brand.equals("") || name.equals("") || describtion.equals("") || price.equals("") || year.equals("") || KM.equals("") ) {
                    Toast.makeText(sell_yout_car_activity.this, "please enter all details first", Toast.LENGTH_SHORT).show();
                }
                else{
                    uploadFile();
                    }
...
//                            upload upload = new upload(car_name.getText().toString().trim(),
...
//                            Toast.makeText(sell_yout_car_activity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
//                        }
//                    });
//        } else {
...
//        }
 ...
 //       FirebaseFirestore db = FirebaseFirestore.getInstance();
       // upload_in_detabase = Chat.toString() + ".jpg";
        ...
        rootRef.child("listed_client").child(id).setValue(profileMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    Toast.makeText(sell_yout_car_activity.this, "Added firebase", Toast.LENGTH_SHORT).show();
                    progressBar.dismiss();
                    startActivity(new Intent(sell_yout_car_activity.this , After_form_Activity.class));
                    return;
                }
                else {
                    Toast.makeText(sell_yout_car_activity.this, "failed", Toast.LENGTH_SHORT).show();
                    progressBar.dismiss();
                }
            }
        });
//        db.collection("listed_client").document(phone).set(profileMap).addOnCompleteListener(new OnCompleteListener<Void>() {
//            @Override
//            public void onComplete(@NonNull Task<Void> task) {
//                if (task.isSuccessful()){
//                    Toast.makeText(sell_yout_car_activity.this, "Added", Toast.LENGTH_SHORT).show();
//                     Toast.makeText(sell_yout_car_activity.this, "failed", Toast.LENGTH_SHORT).show();
////                    progressBar.dismiss();
//
//                }else {
